              ...
              echo '<!--<div class="col-sm-12">-->
                      <div class="tabbable">
                        ...
                        <div class="tab-content">
                          ...
                          if($r[StatusSpm] == 0) {
                            echo "<p><button class='btn btn-sm btn-warning btn-fill' role='button' href='#modal-form' id='id_Spm' value='$r[id_Spm]' data-toggle='modal' id='id_Spm' onClick='md_potongan(this.value)'><i class='fa fa-plus'></i> Tambah Potongan</button></p>";
                          } else {
                            echo "";
                          }
